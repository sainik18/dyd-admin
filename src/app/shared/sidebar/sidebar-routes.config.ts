...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '/users', title: 'Users', icon: 'icon-book-open', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    },
    {
        path: '/activity', title: 'Activity', icon: 'icon-book-open', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    },
    {
        path: '/settings', title: 'Settings', icon: 'icon-book-open', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    },
    // {
