...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '/newdevotion', title: 'New Devotion', icon: 'icon-note', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    },
    {
        path: '/devotion', title: 'Devotion', icon: 'icon-notebook', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    },
    {
    ...
    {
        path: '/activity', title: 'Activity', icon: 'icon-bar-chart', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    },
    {
        path: '/settings', title: 'Settings', icon: 'icon-settings', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    },
    // {
